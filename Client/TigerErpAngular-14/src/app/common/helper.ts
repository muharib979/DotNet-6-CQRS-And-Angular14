...
export class Helper {
  ...
  public static isInvalidControl(fieldName:string, frmControl:FormGroup, isSubmitted:boolean = false):boolean | undefined{
  ...
  public static focusNgSelect(elementId:any){
  ...
  public static focusTextField(elementId:any){
    var element =document.getElementById(elementId)
  ...
  public static onSelectSubmodule(moduleId:any){
